  ...
  return (
    <div className="min-h-screen bg-neutral-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Semantic Tokens */}
        <section id="semantic" className="mb-20 border-t border-border-divider pt-20">
...
<div className="bg-feedback-success-subtle border-l-4 border-feedback-success p-4">
  <p className="text-feedback-success font-semibold">
    Operation successful!
        ...
        {/* Primitive Colors */}
        <section id="colors" className="mb-20 border-t border-border-divider pt-20">
          <div className="flex items-center justify-between mb-6">
...
<button className="bg-bleu-500 hover:bg-bleu-700">
  Hover me
        ...
        {/* Spacing */}
        <section id="spacing" className="mb-20 border-t border-border-divider pt-20">
          <div className="flex items-center justify-between mb-6">
...
<div className="flex gap-md">Items with medium gap</div>`}
        ...
        {/* Typography System */}
        <section id="typography" className="mb-20 border-t border-border-divider pt-20">
...
<button style={{
  ...
  Button Text
        ...
        {/* Border Radius */}
        <section id="radius" className="mb-20 border-t border-border-divider pt-20">
          <div className="flex items-center justify-between mb-6">
